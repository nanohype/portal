...
//
// The vocabulary itself is the Postgres `run_operation` enum
// (migrations/000001_initial_schema.up.sql), which CLAUDE.md makes its one
// source of truth. The tests read it from there; nothing here restates it.
