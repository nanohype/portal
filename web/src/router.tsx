...
const WorkspaceList = lazy(() =>
  named(import('@/components/workspace/WorkspaceList'), 'WorkspaceList'),
);
const WorkspaceDetail = lazy(() =>
  named(import('@/components/workspace/WorkspaceDetail'), 'WorkspaceDetail'),
);
const RunView = lazy(() => named(import('@/components/run/RunView'), 'RunView'));
const PipelineList = lazy(() =>
  named(import('@/components/pipeline/PipelineList'), 'PipelineList'),
);
const PipelineDetail = lazy(() =>
  named(import('@/components/pipeline/PipelineDetail'), 'PipelineDetail'),
);
const PipelineRunView = lazy(() =>
  named(import('@/components/pipeline/PipelineRunView'), 'PipelineRunView'),
);
const AccountList = lazy(() => named(import('@/components/account/AccountList'), 'AccountList'));
const AccountDetail = lazy(() =>
  named(import('@/components/account/AccountDetail'), 'AccountDetail'),
);
const ClusterList = lazy(() => named(import('@/components/cluster/ClusterList'), 'ClusterList'));
const ClusterDetail = lazy(() =>
  named(import('@/components/cluster/ClusterDetail'), 'ClusterDetail'),
);
...
const TemplateList = lazy(() =>
  named(import('@/components/template/TemplateList'), 'TemplateList'),
);
...
const FleetOverview = lazy(() =>
  named(import('@/components/fleet/FleetOverview'), 'FleetOverview'),
);
...
// ── protected children ──────────────────────────────────────────────
const r = <TPath extends string>(path: TPath, component: () => React.ReactNode) =>
